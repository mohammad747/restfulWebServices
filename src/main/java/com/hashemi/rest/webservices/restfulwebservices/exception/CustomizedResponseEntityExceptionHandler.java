package com.hashemi.rest.webservices.restfulwebservices.exception;

import com.hashemi.rest.webservices.restfulwebservices.user.UserNotFountException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDetails> handleUserNotFountException(Exception ex,
                                                                          WebRequest request) throws Exception {
        ErrorDetails errorDetails =
                new ErrorDetails(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
